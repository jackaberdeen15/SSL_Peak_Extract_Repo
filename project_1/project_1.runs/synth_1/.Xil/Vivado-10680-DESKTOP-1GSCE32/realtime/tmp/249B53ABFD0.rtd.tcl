...
set genomeRtd $env(RT_TMP)/249B53ABFD0.rtd
set parallel_map_command "rt::do_reinfer_area_combined 1"
set rt::parallelMoreOptions "set rt::bannerSuppress true"
puts "this genome's name is [subst -nocommands -novariables {full_compare__GB4}]"
...
set genomeName [subst -nocommands -novariables {full_compare__GB4}]
