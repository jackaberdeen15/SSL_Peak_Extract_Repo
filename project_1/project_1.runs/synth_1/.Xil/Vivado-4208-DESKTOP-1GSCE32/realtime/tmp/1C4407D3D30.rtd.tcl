...
set genomeRtd $env(RT_TMP)/1C4407D3D30.rtd
set parallel_map_command "rt::do_reinfer_area_combined 1"
set rt::parallelMoreOptions "set rt::bannerSuppress true"
puts "this genome's name is [subst -nocommands -novariables {peak_removal__GB2}]"
...
set genomeName [subst -nocommands -novariables {peak_removal__GB2}]
