...
#
# Generated by export_simulation on Tue Mar 23 10:36:52 +0000 2021
#
################################################################################
...
'-reset_run' switch to the './div_gen_1.sh' script.

./div_gen_1.sh -reset_run
...
./div_gen_1.sh -noclean_files

For more information on the script, please type './div_gen_1.sh -help'.
