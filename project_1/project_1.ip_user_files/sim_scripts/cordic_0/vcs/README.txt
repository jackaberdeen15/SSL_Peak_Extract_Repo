...
#
# Generated by export_simulation on Sun Mar 28 15:42:41 +0100 2021
#
################################################################################
...
'-reset_run' switch to the './cordic_0.sh' script.

./cordic_0.sh -reset_run
...
./cordic_0.sh -noclean_files

For more information on the script, please type './cordic_0.sh -help'.
